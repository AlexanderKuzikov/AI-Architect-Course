...
> Кандидаты: замена PDF.js на PDFium в документообороте, рендеринг 1С-generated PDF для VLM pipeline, сравнение качества рендеринга на реальных российских документах.
