...
**ANN (Approximate Nearest Neighbor)** (Модуль 12)
...
**Annotation (аннотация типа)** (Модуль 04)
...
**AVIF (AV1 Image File Format)** (Модуль 35)
...
**beforeEach / afterEach** (Модуль 21)
...
**Bounding Box (нормализованный)** (Модуль 10)
...
**Cache-Aside (Lazy Loading)** (Модуль 20)
...
**Calibration (калибровка судьи)** (Модуль 09)
...
**Chain-of-Thought (CoT)** (Модуль 06)
...
**CLS (Cumulative Layout Shift)** (Модули 28, 39)
...
**Confidence Anchoring** (Модуль 10)
...
**Config-driven Design** (Модуль 01)
...
**container style query** (Модуль 31)
...
**Context (context.Context)** (Модуль 05)
...
**Cross-reference table (xref)** (Модуль 15)
...
**CrUX (Chrome User Experience Report)** (Модули 28, 33, 39)
...
**CSSOM (CSS Object Model)** (Модуль 29)
...
**dead letter queue (DLQ)** (Модуль 18)
...
**deoptimization (bailout)** (Модуль 37)
...
**Document Intelligence** (Модуль 10)
...
**dominant color placeholder** (Модуль 35)
...
**Embedding (встраивание)** (Модуль 05)
...
**entity disambiguation** (Модуль 30)
...
**Faithful Hallucination** (Модуль 12)
...
**Field-Level Accuracy** (Модуль 09)
...
**FOUC (Flash of Unstyled Content)** (Модули 29, 36)
...
**FPM (FastCGI Process Manager)** (Модуль 03)
...
**Free-threaded mode (No-GIL)** (Модуль 04)
...
**Function Calling (Tool Use)** (Модуль 06)
...
**Garbage Collection (GC)** (Модуль 01)
...
**GPU Offloading (n_gpu_layers)** (Модуль 08)
...
**Graceful Shutdown** (Модули 01, 18)
...
**Gradient checkpointing** (Модуль 13)
...
**HNSW (Hierarchical Navigable Small World)** (Модуль 12)
...
**Hybrid Reasoning Mode** (Модуль 06)
...
**HyDE (Hypothetical Document Embedding)** (Модуль 12)
...
**idempotent processor** (Модуль 18)
...
**In-context Learning (ICL)** (Модуль 06)
...
**Incremental Re-indexing** (Модуль 12)
...
**INP (Interaction to Next Paint)** (Модули 28, 39)
...
**Instruction Following** (Модуль 06)
...
**IntersectionObserver** (Модуль 34)
...
**IPC (Inter-Process Communication)** (Модуль 22)
...
**ISR (Incremental Static Regeneration)** (Модуль 27)
...
**JIT (Just-In-Time Compiler)** (Модуль 03)
...
**JSON-LD (JSON for Linked Data)** (Модуль 30)
...
**keyspace_hits / keyspace_misses** (Модуль 20)
...
**lazy import waterfall** (Модуль 34)
...
**LCP (Largest Contentful Paint)** (Модули 28, 39)
...
**LoAF (Long Animation Frame)** (Модуль 39)
...
**LoRA (Low-Rank Adaptation)** (Модуль 13)
...
**LRU (Least Recently Used)** (Модуль 20)
...
**MMR (Maximum Marginal Relevance)** (Модуль 12)
...
**Model Version (embedding)** (Модуль 12)
...
**Navigation Timing L2** (Модуль 33)
...
**num_predict / max_tokens** (Модуль 08)
...
**on-demand revalidation** (Модуль 27)
...
**on-the-fly transformation** (Модуль 35)
...
**OOXML (Office Open XML)** (Модули 14, 17)
...
**OpenAI-Compatible API** (Модуль 08)
...
**OTLP (OpenTelemetry Protocol)** (Модуль 26)
...
**Overfitting (переобучение)** (Модуль 13)
...
**Parent-Child Chunking** (Модуль 12)
...
**PeriodicExportingMetricReader** (Модуль 26)
...
**Playwright Test Agents** (Модуль 21)
...
**progressive enhancement** (Модуль 31)
...
**QLoRA (Quantized LoRA)** (Модуль 13)
...
**RAG (Retrieval-Augmented Generation)** (Модули 06, 12)
...
**RDFa (Resource Description Framework in Attributes)** (Модуль 30)
...
**ReAct (Reasoning + Acting)** (Модуль 06)
...
**read-only filesystem** (Модуль 24)
...
**Role (System / User / Assistant)** (Модуль 06)
...
**Routing (по размеру модели)** (Модуль 10)
...
**RRF (Reciprocal Rank Fusion)** (Модуль 12)
...
**RUM (Real User Monitoring)** (Модули 33, 39)
...
**Screenshot Grounding** (Модуль 44)
...
**Self-Enhancement Bias** (Модуль 09)
...
**Sliding Window Counter** (Модуль 23)
...
**SLM (Small Language Model)** (Модуль 08)
...
**Spearman ρ (ранговая корреляция)** (Модуль 09)
...
**SPL (Standard PHP Library)** (Модуль 03)
...
**SSE (Server-Sent Events)** (Модуль 19)
...
**SSG (Static Site Generation)** (Модуль 27)
...
**Stale While Revalidate (SW стратегия)** (Модуль 38)
...
**stale-while-revalidate** (Модули 20, 27, 38)
...
**Structural error rate** (Модуль 13)
...
**structured clone algorithm** (Модуль 22)
...
**T-string (Template String)** (Модуль 04)
...
**TBT (Total Blocking Time)** (Модули 28, 39)
...
**TPS (Tokens Per Second)** (Модуль 08)
...
**TTFB (Time to First Byte)** (Модули 28, 39)
...
**Underfitting (недообучение)** (Модуль 13)
...
**VML (Vector Markup Language)** (Модуль 14)
...
**WaitGroup (sync.WaitGroup)** (Модуль 05)
...
**WCAG (Web Content Accessibility Guidelines)** (Модуль 32)
...
**WeakReference / WeakMap** (Модуль 03)
...
**withoutEnlargement** (Модули 11, 35)
...
**XMP (Extensible Metadata Platform)** (Модуль 15)
...
**Векторное пространство** (Модуль 12)
...
**монотипизированная функция** (Модуль 37)
...
**Постраничная обработка** (Модуль 15)
