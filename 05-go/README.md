...
3. [Современный Go 1.23 / 1.24](#3-современный-go-123--124)
...
|--------|-------------|-------------------|
| Go 1.22 | Февраль 2024 | Range over integers, улучшенный math/rand |
| Go 1.23 | Август 2024 | **Range-over-func, пакет `iter`, timer fix** |
| **Go 1.24** | **Февраль 2025** | **Swiss Tables maps, generic type aliases, `os.Root`, weak pointers, `tool` directive** |

**Go 1.25** ожидается август 2025 — официальных release notes
на март 2026 ещё нет.

**Для нового проекта:** Go 1.24. `go 1.24` в `go.mod`.
