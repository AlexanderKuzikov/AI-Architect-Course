...
### 4. Через карту архитектуры

Для навигации между модулями и понимания как собрать production-систему:

- [`ARCHITECTURE_LANDSCAPE.md`](ARCHITECTURE_LANDSCAPE.md) — карта связей, production-системы, граф зависимостей
- [`TOOLS_COMPARISON.md`](TOOLS_COMPARISON.md) — таблицы «когда брать / когда не брать» по всем инструментам
- [`QUICKREF.md`](QUICKREF.md) — шпаргалка: одна строка на ключевую концепцию модуля
- [`ADR_TEMPLATE.md`](ADR_TEMPLATE.md) — шаблон для документирования собственных архитектурных решений
...
> Курс рассчитан на 47 дней (по модулю в день). Но если времени меньше — вот треки.

### ⏱ 1 час — обзорная карта

```
QUICKREF.md                     (5 мин)  — шпаргалка по всем модулям
ARCHITECTURE_LANDSCAPE.md       (10 мин) — карта связей, граф
TOOLS_COMPARISON.md             (10 мин) — таблицы инструментов
01 §1 (Event Loop)              (10 мин) — понять стиль курса
06 §1-3 (Prompt механика)       (15 мин) — ключевая тема
07 §2 (Structured Output)       (10 мин) — второй столп
```

### ⏱ 3 часа — AI pipeline core

```
01 (JS/Node.js)   (30 мин) — механика платформы
06 (Prompt)       (45 мин) — полный арсенал техник
07 (JSON Schema)  (30 мин) — structured output
08 (Local Inf.)   (30 мин) — VRAM, квантизация, reasoning
11 (Multi-model)  (30 мин) — Key Rotation, Cascade Filter
12 (RAG)          (30 мин) — полный pipeline
09 (Evaluator)    (25 мин) — как измерять качество
```

### ⏱ 1 день — production-ready минимум

Трек выше +:

```
14 (DOCX) / 15 (PDF)    (40 мин) — документы в production
18 (Queues)             (40 мин) — BullMQ, pg-boss, DLQ
19 (HTTP)               (40 мин) — retry, circuit breaker, pooling
20 (Caching)            (40 мин) — L1/L2/L3, stampede
24 (Docker)             (30 мин) — multi-stage, security
25 (CI/CD)              (30 мин) — pipeline design
26 (Logging)            (30 мин) — Pino, OpenTelemetry
21 (Testing)            (25 мин) — testcontainers, AI-тесты
```

### ⏱ 1 неделя — полный курс

Последовательно от 01 к 47, по одному-два модуля в день.
В каждый модуль — 20–60 минут чтения + 10 минут на чеклист.
Выходные — на агентный блок (41–47), он читается вместе.
